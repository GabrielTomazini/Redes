...
class Mago:
    ...
    def imprime(self, d20Final, dano):
        print(
            Back.MAGENTA
            + Fore.WHITE
            + Style.BRIGHT
    ...
    def ataqueAcerto(self):
        ...
        while ataqueValido == False:
            ...
            if acao == "1":
                ...
                ataqueValido = True
                return msg
            elif acao == "3" and self.espacos2Ciclo > 0:
                self.espacos2Ciclo = self.espacos2Ciclo - 1
                d20Final = random.randint(1, 20) + self.inteligencia + bonusProficiencia
                if d20Final == (20 + self.inteligencia + bonusProficiencia):
                    d20Final = 40
                    for i in range(1, 6):
